...
<h2>El siguiente producto esta apunto de caducar</h2>
<h3>El producto {{ $product }} que tiene en el inventario {{ $inventory }} tiene una fecha de caducidad de {{ $expiration }}/h3>
